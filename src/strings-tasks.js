...
function orderAlphabetically(str) {
  ...
  return (
    orderAlphabetically(left.join('')) +
    middle.join('') +
    orderAlphabetically(right.join(''))
  );
}
...
function encodeToRot13(str) {
  return str.replace(/[a-z]/gi, (ch) => {
    ...
    const num = ch.toUpperCase().charCodeAt(0) > 77 ? code - 13 : code + 13;
